...
void Text2DModel::initText2D(const char * texturePath)
{
	// Initialize texture
	...
	// Initialize Shader
	mShaderProgramID = LoadShaders( "../Source/Shaders/TextVertexShader.vertexshader", "../Source/Shaders/TextVertexShader.fragmentshader" );

	// Initialize uniforms' IDs
	Text2DUniformID = glGetUniformLocation( mShaderProgramID, "myTextureSampler" );
}

void Text2DModel::printText2D(const char * text, int x, int y, int size)
{
...
void Text2DModel::cleanupText2D()
{
	// Delete buffers
